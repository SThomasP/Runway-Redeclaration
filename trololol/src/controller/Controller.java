...
public class Controller {
	...
	private ActionListener submitObjectOnRunway;
	private File obstacleList;
	public ArrayList<Obstacle> listOfObstacles = new ArrayList<Obstacle>();
	public ArrayList<Obstacle> obstacleOnRunway = new ArrayList<Obstacle>();
	...
	public ActionListener getSubmitObjectOnRunway(){
		return submitObjectOnRunway;
	}
	...
	public void writeObstacleOnRunway(){
		Obstacle oo = gui.getOutputObstacle();
		obstacleOnRunway.add(oo);
		airportXML.write(airport, true, obstacleOnRunway);;
	...
	public Controller() {
		...
		exportAirport = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				airportXML.write(airport, false, obstacleOnRunway);
			}
		...
		submitObjectOnRunway = new ActionListener(){
