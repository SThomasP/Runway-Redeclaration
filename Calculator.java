...
public final class Calculator {
	...
	static int calculateTora(ObstacleOnRunway or,Aircraft a)
	{
		...
		if(or.closeToThreshold){
			...
			working += "Tora = " + or.getDistanceFromThreshold() + "(Distance From Threshold) - " + stripEnd + "(Strip End) - "  + subtraction + "(Subtraction) + "  + or.getRunway().getDisplacedThreshold() + "(Displaced Threshold)" + System.lineSeparator();
	...
	static int calculateAsda(ObstacleOnRunway or,Aircraft a)
	{
		...
		if(or.closeToThreshold){
			...
			working += "Asda = " + or.getRunway().getAsda() + "(Old Asda) - " + or.getDistanceFromThreshold() + "(Distance From Threshold) - "  + subtraction + "(Subtraction) - "  + or.getRunway().getDisplacedThreshold() + "(Displaced Threshold)" + System.lineSeparator();  
	...
	{
		working += System.lineSeparator() + "Lda Calculation" + System.lineSeparator();
		if(or.closeToThreshold)
		{
			...
			working += "Lda = " + or.getRunway().getLda() + "(Old Lda) - " + or.getDistanceFromThreshold() + "(Distance From Threshold) - "  + subtraction + "(Subtraction) " + System.lineSeparator();  
		...
		{
			working += "Lda = "  + or.getDistanceFromThreshold() + "(Distance From Threshold) - "  + RESA + "(RESA) - "  + stripEnd + "(Strip End)" + System.lineSeparator();  
